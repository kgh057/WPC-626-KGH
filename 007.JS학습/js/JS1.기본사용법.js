...
/******************************************** 
    함수명 : 움직여랏
    기능 : 위치값 이동 및 트랜지션, 동영상태그 넣기
    사용태그 : iframe - 동영상 불러오는 태그
********************************************/
function 움직여랏(나야나, 이동값, 동영상아이디) {
  // 나야나 - 이벤트발생요소 전달변수
  // 이동값 - right속성값에서 뺄 숫자값에 곱할 숫자
  // -> 1,2,3
...
function 마무리해(나야나){
  ...
  나야나.style.transition = '3s ease-in-out 2s,top 2s ease-out';

  // 4. 추가 글자 넣기 : innerText
  나야나.innerText = 'JS의 세계에 오신 것을 환영합니다!';
  // -> innerHTML을 써도 됨
  // -> 만약 태그가 들어갈 경우 innerText를 쓰면 태그가 화면에 그대로 출력된다!

  // 글자관련 CSS 추가하기
  나야나.style.fontSize ='60px';
